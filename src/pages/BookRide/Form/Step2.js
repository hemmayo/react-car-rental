  ...
  render() {
    ...
    return (
      <React.Fragment>
          ...
          <g stroke="none" strokeWidth="1" fill="none" fillRule="evenodd">
            ...
            >
              <g transform="translate(667.000000, 224.000000)">
                ...
                <g transform="translate(0.000000, 48.000000)" fill="#55C173">
        ...
        <div className="my-4">
          <h1 className="text-2xl md:text-3xl font-bold mb-2 md:w-2/3 mx-auto">
            {hideInput
              ? "Would you return to the same pick-up location?"
          ...
          {hideInput ? (
            <>
              <div className="uk-inline mx-1">
                <button
                  className="uk-button uk-button-large bg-blue-500 hover:bg-blue-700 text-white rounded"
                  onClick={() => editState("dropoff", pickup)}
                >
                  Yes, please
                </button>
              </div>
              <div className="uk-inline mx-1 my-2 md:my-auto">
                <button
                  type="button"
                  className="uk-button uk-button-large uk-button-default rounded"
